...
import {  GetAllGroupByUserQuery, GetUserGroupDTOQuery } from '../models/user-group/user-group-dto/get-user-group-query';
...
export class UserGroupService extends BaseService<UserGroup> {
  ...
  getAllGroupsByUser(query: GetAllGroupByUserQuery): Observable<PaginateRsult<UserGroupDto>> {
    let params = this.httpParams(query)
    return this.httpClient.get<PaginateRsult<UserGroupDto>>(`${this.url}/GetAllGroupsByUser`, { params });
  }

  getAllUsersByGroup(query: GetAllGroupByUserQuery): Observable<PaginateRsult<UserGroupDto>> {
    let params = this.httpParams(query)
    return this.httpClient.get<PaginateRsult<UserGroupDto>>(`${this.url}/GetAllUsersByGroup`, { params });
  }
