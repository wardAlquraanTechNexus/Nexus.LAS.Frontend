...
@Component({
  selector: 'app-active-private-fpcs-table',
  standalone:false,
  templateUrl: './active-private-fpcs-table-component.html',
  styleUrl: './active-private-fpcs-table-component.scss'
})
export class ActivePrivateFpcsTableComponent extends BaseFpcsComponent {
