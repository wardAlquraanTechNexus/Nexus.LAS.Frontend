...
@Component({
  selector: 'app-active-private-law-firms-table-component',
  standalone: false,
  templateUrl: './active-private-law-firms-table-component.html',
  styleUrl: './active-private-law-firms-table-component.scss'
})
export class ActivePrivateLawFirmsTableComponent extends BaseLawFirmsComponent {
