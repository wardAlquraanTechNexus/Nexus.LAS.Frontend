...
@Component({
  selector: 'app-active-private-transactions-table-component',
  standalone: false,
  templateUrl: './active-private-transactions-table-component.html',
  styleUrl: './active-private-transactions-table-component.scss'
})
export class ActivePrivateTransactionsTableComponent extends BaseTransactionsComponent
{
