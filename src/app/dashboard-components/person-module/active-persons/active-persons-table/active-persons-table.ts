...
@Component({
  selector: 'app-active-persons-table',
  standalone: false,
  templateUrl: './active-persons-table.html',
  styleUrl: './active-persons-table.scss'
})
export class ActivePersonsTable extends BasePersonsComponent {
