...
@Component({
  ...
  standalone:false,
  templateUrl: './active-public-persons-table.html',
  styleUrl: './active-public-persons-table.scss'
})
export class ActivePublicPersonsTable  extends BasePersonsComponent {
