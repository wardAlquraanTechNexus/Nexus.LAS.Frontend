...
@Component({
  selector: 'app-active-private-properties-table-component',
  standalone: false,
  templateUrl: './active-private-properties-table-component.html',
  styleUrl: './active-private-properties-table-component.scss'
})
export class ActivePrivatePropertiesTableComponent  extends BasePropertiesComponent
{
