...
@Component({
  selector: 'app-active-properties-table-component',
  standalone: false,
  templateUrl: './active-properties-table-component.html',
  styleUrl: './active-properties-table-component.scss'
})
export class ActivePropertiesTableComponent extends BasePropertiesComponent {
